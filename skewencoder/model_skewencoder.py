...
def skewencoder_model_init(AE_dataset, encoder_layers, loss_coeff, iter=0, PREV_ITER_FOLDER="", *args):
...
def skewencoder_model_trainer(model, datamodule, iter_folder):
    # define callbacks
