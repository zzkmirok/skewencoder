...
wall1: LOWER_WALL ARG=c1 AT=0.0 KAPPA=100.0 EXP=2.0 EPS=1.0 OFFSET=0.0
...
wall1: LOWER_WALL ARG=c1 AT=0.0 KAPPA=100.0 EXP=2.0 EPS=1.0 OFFSET=0.0
cv_wall_heavy: LOWER_WALL ARG=cv_heavy AT=0.1 KAPPA=100.0 EXP=2.0 EPS=1.0 OFFSET=0.0
cv_wall_h_adj: UPPER_WALL ARG=cv_h_adj AT=-0.1 KAPPA=200.0 EXP=2.0 EPS=1.0 OFFSET=0.0


PRINT FMT=%g STRIDE=10 FILE=./COLVAR ARG=C1C6,C1N5,C6N5,H2C1,H3C1,H4C1,cv_heavy.*,cv_h_adj.*'''
