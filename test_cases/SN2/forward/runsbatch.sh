...
# UPPER_WALLS ARG=d1 AT=+4.0 KAPPA=200.0 EXP=2 LABEL=uwall_1
# UPPER_WALLS ARG=d5 AT=+4.0 KAPPA=200.0 EXP=2 LABEL=uwall_2
LOWER_WALLS ARG=h1 AT=+1.7 KAPPA=200.0 EXP=2 LABEL=lwall_1
